...
interface AirlineTemplate {
  ...
  headerTextColor?: string; // New: Specific color for the large airline name text
  fontFamily: string;
...
const airlineTemplates: Record<string, AirlineTemplate> = {
  // --- North America --- (Colors assumed to be relatively accurate or to be fine-tuned by you)
  ...
  // --- Europe --- (Updated colors and headerTextColor)
  'BA': { primaryColor: '#003876', secondaryColor: '#E21A23', headerTextColor: '#003876', fontFamily: 'Helvetica', logoPosition: 'center', paperSize: [595.28, 841.89], usesQrCode: true, logoPath: 'server/assets/logos/Europe/BA.png' }, // BA Blue, Red accent
  'VS': { primaryColor: '#E50000', secondaryColor: '#4A4A4A', headerTextColor: '#E50000', fontFamily: 'Helvetica', logoPosition: 'left', paperSize: [595.28, 841.89], usesQrCode: true, logoPath: 'server/assets/logos/Europe/VS.png' }, // Virgin Red, Dark Grey text
  'AF': { primaryColor: '#002157', secondaryColor: '#ED1B2E', headerTextColor: '#002157', fontFamily: 'Helvetica', logoPosition: 'center', paperSize: [595.28, 841.89], usesQrCode: true, logoPath: 'server/assets/logos/Europe/AF.png' }, // Air France Blue, Red accent
  'KL': { primaryColor: '#00A1DE', secondaryColor: '#00305C', headerTextColor: '#00305C', fontFamily: 'Helvetica', logoPosition: 'left', paperSize: [595.28, 841.89], usesQrCode: true, logoPath: 'server/assets/logos/Europe/KL.png' }, // KLM Blue, Darker Blue text
  'LX': { primaryColor: '#E30613', secondaryColor: '#231F20', headerTextColor: '#E30613', fontFamily: 'Helvetica', logoPosition: 'center', paperSize: [595.28, 841.89], usesQrCode: true, logoPath: 'server/assets/logos/Europe/LX.png' }, // SWISS Red, Black text
  'SK': { primaryColor: '#004B93', secondaryColor: '#FFFFFF', headerTextColor: '#004B93', fontFamily: 'Helvetica', logoPosition: 'left', paperSize: [595.28, 841.89], usesQrCode: true, logoPath: 'server/assets/logos/Europe/SK.png' }, // SAS Blue, White for secondary border
  'DY': { primaryColor: '#D81924', secondaryColor: '#00375A', headerTextColor: '#D81924', fontFamily: 'Helvetica', logoPosition: 'center', paperSize: [595.28, 841.89], usesQrCode: true, logoPath: 'server/assets/logos/Europe/DY.png' }, // Norwegian Red, Dark Blue for secondary border

  // --- Middle East --- (Updated colors and headerTextColor)
  'EK': { primaryColor: '#D81E05', secondaryColor: '#D4AF37', headerTextColor: '#231F20', fontFamily: 'Helvetica-Bold', logoPosition: 'center', paperSize: [595.28, 841.89], usesQrCode: true, logoPath: 'server/assets/logos/MiddleEast/EK.png' }, // Emirates Red, Gold secondary, Black text
  'EY': { primaryColor: '#A98C5A', secondaryColor: '#4A3B30', headerTextColor: '#4A3B30', fontFamily: 'Helvetica', logoPosition: 'right', paperSize: [595.28, 841.89], usesQrCode: true, logoPath: 'server/assets/logos/MiddleEast/EY.png' }, // Etihad Gold, Dark Brown text/secondary
  'QR': { primaryColor: '#5C0632', secondaryColor: '#B8B8B8', headerTextColor: '#5C0632', fontFamily: 'Helvetica', logoPosition: 'left', paperSize: [595.28, 841.89], usesQrCode: true, logoPath: 'server/assets/logos/MiddleEast/QR.png' }, // Qatar Maroon, Silver/Grey secondary

  // --- Asia --- (Updated colors and headerTextColor)
  'AK': { primaryColor: '#FF0000', secondaryColor: '#000000', headerTextColor: '#FF0000', fontFamily: 'Helvetica', logoPosition: 'center', paperSize: [595.28, 841.89], usesQrCode: true, logoPath: 'server/assets/logos/Asia/AK.png' }, // AirAsia Red, Black secondary/text
  'CZ': { primaryColor: '#005BAC', secondaryColor: '#EE2A34', headerTextColor: '#005BAC', fontFamily: 'Helvetica', logoPosition: 'left', paperSize: [595.28, 841.89], usesQrCode: true, logoPath: 'server/assets/logos/Asia/CZ.png' }, // China Southern Blue, Red secondary
  'CX': { primaryColor: '#006564', secondaryColor: '#D0D0D0', headerTextColor: '#006564', fontFamily: 'Helvetica', logoPosition: 'center', paperSize: [595.28, 841.89], usesQrCode: true, logoPath: 'server/assets/logos/Asia/CX.png' }, // Cathay Dark Teal, Light Grey secondary
  'JL': { primaryColor: '#E3001B', secondaryColor: '#222222', headerTextColor: '#222222', fontFamily: 'Helvetica', logoPosition: 'left', paperSize: [595.28, 841.89], usesQrCode: true, logoPath: 'server/assets/logos/Asia/JL.png' }, // JAL Red, Black text/secondary
  'KE': { primaryColor: '#00A0E0', secondaryColor: '#CD2E3A', headerTextColor: '#00A0E0', fontFamily: 'Helvetica', logoPosition: 'center', paperSize: [595.28, 841.89], usesQrCode: true, logoPath: 'server/assets/logos/Asia/KE.png' }, // Korean Air Sky Blue, Taegeuk Red secondary
  'TG': { primaryColor: '#5F259F', secondaryColor: '#FFC700', headerTextColor: '#5F259F', fontFamily: 'Helvetica', logoPosition: 'right', paperSize: [595.28, 841.89], usesQrCode: true, logoPath: 'server/assets/logos/Asia/TG.png' }, // Thai Purple, Gold secondary
  ...
  'MH': { primaryColor: '#00327D', secondaryColor: '#CC0000', headerTextColor: '#00327D', fontFamily: 'Helvetica', logoPosition: 'center', paperSize: [595.28, 841.89], usesQrCode: true, logoPath: 'server/assets/logos/Asia/MH.png' }, // Malaysia Airlines Blue, Red secondary
  'GA': { primaryColor: '#1A4A9C', secondaryColor: '#00A89D', headerTextColor: '#1A4A9C', fontFamily: 'Helvetica', logoPosition: 'left', paperSize: [595.28, 841.89], usesQrCode: true, logoPath: 'server/assets/logos/Asia/GA.png' }, // Garuda Blue, Teal secondary
  'VN': { primaryColor: '#003366', secondaryColor: '#FFCC00', headerTextColor: '#003366', fontFamily: 'Helvetica', logoPosition: 'center', paperSize: [595.28, 841.89], usesQrCode: true, logoPath: 'server/assets/logos/Asia/VN.png' }, // Vietnam Airlines Dark Blue, Gold Lotus Yellow secondary
  
  // --- Oceania, Africa, Central America & Caribbean, South America ---
  // (These would also need their colors researched and headerTextColor added when activated)
  'QF': { primaryColor: '#E40000', secondaryColor: '#FFFFFF', headerTextColor: '#E40000', fontFamily: 'Helvetica', logoPosition: 'left', paperSize: [595.28, 841.89], usesQrCode: true, logoPath: undefined },
  'VA': { primaryColor: '#E5001A', secondaryColor: '#333333', headerTextColor: '#E5001A', fontFamily: 'Helvetica', logoPosition: 'right', paperSize: [595.28, 841.89], usesQrCode: false, logoPath: undefined, abn: '36 090 670 965'},
  // ... (and so on for JQ, NZ, SA, MS, AT, CM, LR, AM, LA, AV, LP, EQ with placeholder colors and headerTextColor)
...
// --- Helper Functions (Keep as they are, including renamed formatDateStyled, formatTimeStyled) ---
...
function formatDateStyled(dateInput?: string | Date, format: 'short_date_time' | 'full_date' | 'day_month_year' = 'full_date'): string { /* ... as before ... */ if (!dateInput) return 'N/A'; try { const date = typeof dateInput === 'string' ? new Date(dateInput) : dateInput; if (isNaN(date.getTime())) return typeof dateInput === 'string' ? dateInput : 'N/A'; if (format === 'short_date_time') return `${date.toLocaleDateString(undefined, { weekday: 'long' }).toUpperCase()} ${date.toLocaleDateString(undefined, { day: '2-digit', month: 'short' }).toUpperCase()}`; if (format === 'day_month_year') return `${date.toLocaleDateString(undefined, { day: '2-digit' }).toUpperCase()} ${date.toLocaleDateString(undefined, { month: 'short' }).toUpperCase()} ${date.getFullYear()}`; return `${date.toLocaleDateString(undefined, { weekday: 'long' })} ${date.getDate()} ${date.toLocaleDateString(undefined, { month: 'short' })}`; } catch { return typeof dateInput === 'string' ? dateInput : 'N/A'; } }
function formatTimeStyled(timeInput?: string | Date, useAMPM = true): string { /* ... as before ... */     if (!timeInput) return 'N/A'; try { const dateObj = typeof timeInput === 'string' ? new Date(timeInput.includes('T') ? timeInput : `1970-01-01T${timeInput}`) : timeInput; if (isNaN(dateObj.getTime())) { if (typeof timeInput === 'string' && /^\d{1,2}:\d{2}(?:\s*(?:am|pm))?$/i.test(timeInput)) return timeInput.toLowerCase(); if (typeof timeInput === 'string' && /^\d{1,2}:\d{2}$/.test(timeInput)) return timeInput; return typeof timeInput === 'string' ? timeInput : 'N/A'; } let timeStr = dateObj.toLocaleTimeString(undefined, { hour: useAMPM ? 'numeric' : '2-digit', minute: '2-digit', hour12: useAMPM, hourCycle: useAMPM? undefined : 'h23' }); return useAMPM ? timeStr.toLowerCase() : timeStr; } catch { return typeof timeInput === 'string' ? timeInput : 'N/A'; } }
function drawHorizontalLine(doc: PDFKit.PDFDocument, y: number, weight: 'light' | 'heavy' = 'light', color?: string) { /* ... as before ... */ doc.moveTo(PAGE_MARGIN, y) .lineTo(doc.page.width - PAGE_MARGIN, y) .strokeColor(color || DEFAULT_BORDER_COLOR) .lineWidth(weight === 'heavy' ? 1.5 : 0.75) .stroke(); }
...
function drawTicketHeader(doc: PDFKit.PDFDocument, ticket: TicketWithDetails, template: AirlineTemplate, airlineCode: string) {
    ...
    // Use headerTextColor, fallback to secondary, then primary, then dark
    ...
    doc.fillColor(nameColor)
       .text(airlineName, airlineNameTextX, airlineNameTextY, {
           width: logoDrawnSuccessfully ? airlineNameTextWidth : LOGO_MAX_WIDTH,
    ...
    doc.font(FONT_BOLD).fontSize(FONT_SIZE_MEDIUM + 1).fillColor(TEXT_COLOR_DARK).text(passengerNameVal, leftColX, currentY);
